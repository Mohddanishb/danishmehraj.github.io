        ...
        <div class="container">
			<div class="nav-wrapper"><a id="logo-container" href="#" class="brand-logo"><img src="images/logo.png" class="logo" alt="Logo" /></a>
                ...
                <ul id="nav-mobile" class="side-nav">
                    ...
                    <li class="waves-effect waves-dark"><a href="#"><img src="../images/blog.png" class="sidebar-logo" alt="Blog logo" />Blog</a></li>
...
<!--Floating action button embedded by Danish Mehraj-->			  
			<div class="containers">             
				...
				<a href="#" tooltip="Blog" class="buttons"></a>
                  ...
                  <div class="col l4 s12">
                      <div class="social-icons">
                          ...
                          <div class="center">
                              ...
                              <a href="mailto:iwrite@danishmehraj.com" target="_top"><i class="fa fa-envelope"></i></a>
                          </div>
                      </div>
                  </div>
                  <div class="col l4 s12">
